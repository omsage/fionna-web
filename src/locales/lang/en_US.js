...
const suite = {
    ...
    devicePlace: 'Please select the test device, you can filter by model, note, Chinese name, or serial number',
...
const perf = {
    ...
    select: "(Optional) Click here to specify the performance of the monitored application process",
...
const androidRemoteTS = {
    ...
    code: {
        ...
        precautionsText: 'This feature is still in beta testing and risk commands such as reboot, rm, su are temporarily blocked',
